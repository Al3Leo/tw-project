...
<body>
    ...
    <div class="hero">
        <iframe src="https://solarsystem.nasa.gov/gltf_embed/2349/" frameborder="0" allow="fullscreen" loading="lazy">
        ...
        <div class="hero__text">
            ...
            <p id="capitalize">
                <a href=<?php echo "https://science.nasa.gov/" . $nomeEvento ?> target="_blank">Titan</a> is Saturn's largest moon and one of the most intriguing worlds in our solar system. Titan is the <b>second largest moon</b> in the solar system and is unique for its dense atmosphere and surface lakes of liquid methane and ethane. Titan orbits Saturn and has a thick, nitrogen-rich atmosphere that obscures its surface.<br>Titan is <b>similar</b> to Earth in some fascinating ways, particularly because it has a weather cycle and surface features reminiscent of our own planet, including rivers, lakes, and seas. The surface of Titan is covered with a diverse range of geological features, from dunes to mountains. Scientific missions, such as the Cassini-Huygens mission, have provided valuable data about Titan, revealing its complex environment and potential for hosting life.
            </p>
        </div>
    </div>
    <main id="main" class="d-flex flex-row">
        <div class="main__left">
            ...
            <p>Welcome to Titan, Saturn's largest moon, celebrated for its captivating landscapes and mysterious presence! A journey to this extraordinary world offers an unparalleled experience, filled with vast methane lakes, towering dunes, and profound silence. With the right preparation and guidance, Titan will reveal its hidden wonders.</p>
            <div class="main__left__section1 d-flex flex-row justify-content-center align-items-center">
                ...
                <div class="main__left__section1__whatSee">
                    ...
                    <ol>
                        <li>
                            <p><span>Kraken Mare:</span> Discover Titan's largest sea, filled with liquid methane, offering breathtaking views of its mysterious surface.</p>
                        </li>
                        <li>
                            <p><span>Shangri-La Dune Field:</span> Explore the vast dunes of Titan, created by its thick atmosphere and unique surface conditions.</p>
                        </li>
                        <li>
                            <p><span>Huygens Landing Site:</span> Venture into the historic landing site of the Huygens probe, providing valuable data about Titan's environment.</p>
                        </li>
                        <li>
                            <p><span>Dragonfly Crater:</span> Witness the planned landing site for the Dragonfly mission, which aims to explore Titan's diverse and intriguing geology.</p>
                        </li>
                    </ol>
                </div>
            </div>
            <div class="main__left__tripKnowledge">
                ...
                <p>
                    Get ready for a one-of-a-kind experience on <b>Titan!</b> This moon of Saturn features <b>stunning methane lakes</b>, thick atmosphere, and a fascinating <b>history</b>. Equip yourself with specialized gear to explore the frigid terrain, and follow our expert guides for a safe and unforgettable journey. Learn about Titan's role in mythology and the scientific discoveries made about this enigmatic moon. The trip lasts 10 days, with daily excursions and moments of relaxation at our state-of-the-art facilities.

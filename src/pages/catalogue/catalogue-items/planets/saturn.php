...
<body>
    ...
    <div class="hero">
        ...
        <div class="hero__text">
            ...
            <p id="capitalize">
                <a href=<?php echo "https://science.nasa.gov/" . $nomeEvento ?> target="_blank">Saturn</a> is the sixth planet from the Sun and the second-largest in the solar system. Saturn is the <b>brightest object in the sky</b> after the Sun, Moon, and Venus. Saturn's rings are composed of ice and rock.

                <br>
                Saturn is <b>similar</b> in composition to <b>Jupiter</b>, and is sometimes called the <b>ringed giant</b>. Its thick atmosphere is made up primarily of hydrogen and helium, making it the <b>second largest planet</b> in our solar system. Below the cloud tops, Saturn has numerous moons and stunning ring formations.
            </p>
    ...
    <main id="main" class="d-flex flex-row">
        <div class="main__left">
            ...
            <p>Welcome to Saturn, the ringed giant of our solar system, renowned for its beauty and mystery! A journey to this fascinating world offers an extraordinary experience filled with mesmerizing rings and dynamic weather. With proper preparation and guidance, Saturn will unveil its wonders.</p>
            <div class="main__left__section1 d-flex flex-row justify-content-center align-items-center">
                ...
                <div class="main__left__section1__whatSee">
                    ...
                    <ol>
                        <li>
                            <p><span>Enceladus' Geysers:</span> Discover the stunning geysers that shoot icy water particles from Enceladus' surface, creating beautiful plumes in space.</p>
                        </li>
                        <li>
                            <p><span>Rings of Saturn:</span> Explore the majestic ring system of Saturn, made of ice and rock particles, offering a spectacular view.</p>
                        </li>
                        <li>
                            <p><span>Titan's Lakes:</span> Venture into the methane and ethane lakes of Titan, Saturn's largest moon, perfect for adventurous exploration.</p>
                        </li>
                        <li>
                            <p><span>Hexagon Storm:</span> Witness the unique hexagon-shaped storm at Saturn's north pole, a mesmerizing atmospheric phenomenon.</p>
                        </li>
                    </ol>
            ...
            <div class="main__left__tripKnowledge">
                ...
                <p>
                    Get ready for a one-of-a-kind experience on <b>Saturn!</b> The planet features <b>stunning ring systems</b>, unique weather patterns, and a rich <b>history</b>. Equip yourself with advanced space suits to navigate the mesmerizing rings, and follow our expert guides for a safe and unforgettable journey. Learn about Saturn's role in mythology and the scientific discoveries made about this majestic planet. The trip lasts 10 days, with daily excursions and moments of relaxation at our state-of-the-art facilities. Feel free to adjust or expand upon these sections as needed for your site. Let me know if there's anything else you'd like to add!
                </p>

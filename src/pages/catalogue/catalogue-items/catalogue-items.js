...
items.forEach((item) => {
  ...
  question.addEventListener("click", () => {
    ...
    document.querySelectorAll(".main__left__tripKnowledge__item__answer").forEach(a => a.classList.remove("open"));
    document.querySelectorAll(".main__left__tripKnowledge__arrow").forEach(a => a.classList.remove("open"));
